...
date: "Due 11:59pm Friday Sept 25 2026"
output:
...
(b) Use the earth radius $R=6371$ km. Can you compute the geodesic distances: (1) between Phoenix (33.28N, 112.03W) and Chicago (41.52N, 87.39W), and (2) between New York (40.43N, 73.56W) and Los Angeles (34.03N, 118.15W)?
...
Show that a valid variogram $\gamma(\cdot)$ satisfies the negative definiteness condition, i.e. for any set of locations ${\bf s}_1,\cdots, {\bf s}_n$ and any set of $a_1,\cdots, a_n$ such that $\sum_{i=1}^n a_i=0$, we have
$$\sum_i\sum_j a_ia_j\gamma({\bf s}_i-{\bf s}_j) \leq 0$$
...
(a) Plot the sampled sites of the region. Add contour lines to the plot.
